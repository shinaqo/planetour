  ...
  <div class="col s12 m12">
    <div class="card">
      <div class="card-content">
        ...
        <form id="formularioEditar" method="post" action="/trabajador/{{$data_trabajador->id_trabajador}}" enctype="multipart/form-data" onsubmit="return validar_trabajador();">
          ...
          <div class="input-field col s4">
            ...
            <label class="active" for="ubicacion">imagen</label>
